...
<li class="wc_payment_method payment_method_<?= $gateway->id; ?>">
	<input id="payment_method_<?= $gateway->id; ?>" type="radio" class="input-radio" name="payment_method" value="<?= esc_attr( $gateway->id ); ?>" <?php checked( $gateway->chosen, true ); ?> data-order_button_text="<?= esc_attr( $gateway->order_button_text ); ?>" />
