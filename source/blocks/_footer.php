<?php $images = json_decode(file_get_contents("../../source/temp/images.json")); ?>
            ...
            <div class="blog-items flex flex-wrap -mx-2">
                <div class="blog-item cursor-pointer w-1/4 px-2">
                    <div class="image-box product-box overflow-hidden relative">
                        <div class="image absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat" style="background-image:url(<?= $images[10]->url->small ?>)"></div>
                ...
                <div class="blog-item cursor-pointer w-1/4 px-2">
                    <div class="image-box product-box overflow-hidden relative">
                        <div class="image absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat" style="background-image:url(<?= $images[11]->url->small ?>)"></div>
                ...
                <div class="blog-item cursor-pointer w-1/4 px-2">
                    <div class="image-box product-box overflow-hidden relative">
                        <div class="image absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat" style="background-image:url(<?= $images[12]->url->small ?>)"></div>
                ...
                <div class="blog-item cursor-pointer w-1/4 px-2">
                    <div class="image-box product-box overflow-hidden relative">
                        <div class="image absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat" style="background-image:url(<?= $images[13]->url->small ?>)"></div>
                        <div class="label absolute top-0 right-0"><span class="label-text">Hello</span></div>
                    </div>
                    <div class="content">
                        <div class="title text-lg font-bold text-white mt-2 mb-2">Lorem ipsum dolor sit, amet consectetur adipisicing.</div>
