...
<div class="hero-banner p-0 md:py-5">
    <div class="container p-0 md:px-5 mx-auto">
        <div class="flex flex-wrap rounded-none md:rounded-md overflow-hidden">
            ...
            <div class="w-full md:w-1/4 bg-gray-200">
                <?php for ($i = 1; $i < 5; $i++) : ?>
                    <div class="p-3 cursor-pointer hover:bg-gray-300 <?php echo ($i < 4) ? 'border-b' : '' ?> <?php echo ($i > 0) ? '-mt-px' : '' ?>">
    ...
    <div class="container px-5 mx-auto">
        <div class="py-10 relative">
            ...
            <div class="blog-items flex flex-wrap -mx-1">
                <div class="hidden md:block w-full md:w-3/4 px-1">
                    <div class="blog-item relative cursor-pointer mb-5 md:mb-0 w-full h-full flex flex-wrap bg-cover bg-center bg-no-repeat" style="background-image:url(<?php echo get_the_post_thumbnail_url($all_posts[4]->ID) ?>)">
                        <!-- <div class="image-box product-box overflow-hidden relative w-1/3 md:w-full">
                            <div class="image absolute w-full h-full top-0 left-0 bg-gray-200"></div>
                            <div class="absolute top-0 right-0 flex">
                ...
                <div class="w-full md:w-1/4 px-1">
                    <a href="<?php echo get_permalink($all_posts[5]->ID) ?>" class="blog-item cursor-pointer w-full mb-0 md:mb-2 flex flex-wrap">
                        <div class="image-box product-box overflow-hidden relative w-full">
                            ...
                            <div class="absolute flex flex-col justify-end top-0 left-0 w-full h-full" style="background-color: rgba(0,0,0,0.5)">
                                <div class="p-4">
                                    <!-- <div class="label label-blue inline-block md:hidden"><span class="label-text"><?php echo get_the_category($all_posts[5]->ID)[0]->name ?></span></div> -->
                                    <div class="title text-base leading-none text-white mb-1 truncate"><?php echo $all_posts[5]->post_title ?></div>
                    ...
                    <a href="<?php echo get_permalink($all_posts[6]->ID) ?>" class="blog-item cursor-pointer w-full mb-0 md:mb-2 flex flex-wrap">
                        <div class="image-box product-box overflow-hidden relative w-full">
                            ...
                            <div class="absolute flex flex-col justify-end top-0 left-0 w-full h-full" style="background-color: rgba(0,0,0,0.5)">
                                <div class="p-4">
                                    <!-- <div class="label label-blue inline-block md:hidden"><span class="label-text"><?php echo get_the_category($all_posts[6]->ID)[0]->name ?></span></div> -->
                                    <div class="title text-base leading-none text-white mb-1 truncate"><?php echo $all_posts[6]->post_title ?></div>
                    ...
                    <a href="<?php echo get_permalink($all_posts[7]->ID) ?>" class="blog-item cursor-pointer w-full flex flex-wrap">
                        <div class="image-box product-box overflow-hidden relative w-full">
                            ...
                            <div class="absolute flex flex-col justify-end top-0 left-0 w-full h-full" style="background-color: rgba(0,0,0,0.5)">
                                <div class="p-4">
                                    <!-- <div class="label label-blue inline-block md:hidden"><span class="label-text"><?php echo get_the_category($all_posts[7]->ID)[0]->name ?></span></div> -->
                                    <div class="title text-base leading-none text-white mb-1 truncate"><?php echo $all_posts[7]->post_title ?></div>
...
<div>
    <div class="container px-5 mx-auto">
        ...
        <div class="filters">
            ...
            <?php foreach ($cats as $key => $cat) : ?>
                <div class="label clickable inline-block mb-1" data-filter=".<?php echo $cat->slug ?>"><span class="label-text"><?php echo $cat->name ?></span></div>
            <?php endforeach; ?>
            <div id="openTags" class="label label-blue cursor-pointer inline-block mb-1"><span class="label-text">Filters <i class="fas fa-caret-down"></i></span></div>
        </div>
        <div id="tagsBox" class="flex mt-2 hidden">
            ...
            <div class="filters bg-gray-100 py-4 px-5">
                <?php foreach ($tags as $key => $tag) : ?>
                    <div class="label label-blue cursor-pointer inline-block mb-1" data-filter=".<?php echo $tag->slug ?>"><span class="label-text"><?php echo $tag->name ?></span></div>
                <?php endforeach; ?>
    ...
    <div class="container px-0 md:px-5 mx-auto">
        <div class="py-5 w-full relative">
            <div class="blog-items mixer flex flex-wrap -mx-1">
                        ...
                        <div class="hidden md:block image-box product-box overflow-hidden relative w-full">
                            ...
                            <div class="absolute flex flex-col justify-end top-0 left-0 w-full h-full" style="background-color: rgba(0,0,0,0.5)">
                                <div class="p-5">
                                    ...
                                    <div class="title text-lg leading-snug text-white mb-1"><?php echo $all_posts[$x]->post_title ?></div>
