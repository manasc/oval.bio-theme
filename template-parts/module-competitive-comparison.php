            ...
            <div class="w-full absolute bottom-0 py-12 px-5">
                <div class="flex flex-wrap items-center justify-center -mx-4">
                    ...
                    <div class="cta flex-none px-4">
                        <a href="<?= the_permalink($compArticle->ID) ?>" class="button">
                            Full Article
        ...
        <div class="flex flex-wrap -mx-2 relative overflow-hidden" style="max-height: 400px;">
            <?php if (has_post_thumbnail($compArticle->ID)) : ?>
                <div class="w-full md:w-1/2 px-2">
                    <div class="bg-gray-500 bg-cover bg-center bg-no-repeat" style="padding-top: 100%; background-image: <?= get_the_post_thumbnail_url($compArticle->ID); ?>"></div>
                </div>
            <?php endif; ?>
            <div class="w-full md:w-1/2 px-2">
                <div class="anchor-content">
                    <h1 class="text-3xl mb-5 leading-snug"><?= $compArticle->post_title ?></h1>
                    <?= $compArticle->post_content ?>
                </div>
            </div>
        </div>
    <?php endif; ?>
