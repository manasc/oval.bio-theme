...
<div class="hero-banner p-5">
    <!-- <div class="container mx-auto"> -->
    <div class="flex flex-wrap rounded-md overflow-hidden">
        <div class="w-full h-64 md:h-auto md:w-3/4 bg-cover bg-no-repeat bg-center relative bg-gray-200" style="background-image:url(<?php echo get_the_post_thumbnail_url($all_posts[0]->ID) ?>)">
            ...
            <div class="absolute top-0 right-0 flex">
                ...
                <div class="label" style="background-color: #ecc94b; border-color: #ecc94b"><span class="label-text"><i class="fas fa-star mr-1"></i></div>
            </div>
                ...
                <div class="p-3 <?php echo ($i == 0) ? 'bg-gray-700 text-white' : 'cursor-pointer hover:bg-gray-300' ?> <?php echo ($i < 4) ? 'border-b' : '' ?> <?php echo ($i > 0) ? '-mt-px' : '' ?>">
                    <div class="flex items-center">
                        ...
                        <div class="w-2/3 pl-4">
                            <h6 class="text-xl mb-2 truncate"><?php echo $all_posts[$i]->post_title ?></h6>
    ...
    <div class="container mx-auto">
        <div class="py-24 w-full relative">
            ...
            <div class="blog-items flex flex-wrap -mx-2">
                <div class="w-3/4">
                    <div class="blog-item cursor-pointer mb-5 md:mb-0 w-full px-2 flex flex-wrap">
                ...
                <div class="w-1/4 px-2">
                    <div class="blog-item cursor-pointer mb-5 md:mb-0 w-full mb-2 flex flex-wrap">
                        <div class="image-box product-box overflow-hidden relative w-1/3 md:w-full">
...
<div>
    <div class="container mx-auto">
        <p class="mb-2">Filter all articles:</p>
        <div class="filters">
    ...
    <div class="container mx-auto">
        <div class="py-10 w-full relative">
            <div class="blog-items mixer flex flex-wrap -mx-2">
                <?php for ($x = 7; $x < count($all_posts); $x++) : ?>
