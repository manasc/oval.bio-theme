...
if (!function_exists('oval_bio_setup')):
	...
	function oval_bio_setup() {
		...
		*/
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__('Primary', 'oval-bio'),
			)
		);
...
function oval_bio_scripts() {
	wp_enqueue_style('oval-bio-style', get_template_directory_uri() . '/dist/app.css', array(), _S_VERSION);
	// wp_style_add_data('oval-bio-style', 'rtl', 'replace');

	wp_enqueue_script('oval-bio-main', get_template_directory_uri() . '/dist/app.js', array(), _S_VERSION, true);
	// wp_enqueue_script('oval-bio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);

	wp_enqueue_script('oval-bio-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true);
