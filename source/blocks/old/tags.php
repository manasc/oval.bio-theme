    ...
    <div class="container mx-auto flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 mb-5">
            ...
            <div class="labels flex flex-wrap -mx-1">
                <?php foreach ($arr as $label) : ?>
                    <div class="px-1">
                        <div class="label clickable"><span class="label-text"><?= $label ?></span></div>
                    </div>
                <?php endforeach ?>
            </div>
        </div>
        <div class="w-full md:w-1/2 mb-5">
            ...
            <div class="labels flex flex-wrap -mx-1">
                <?php foreach ($arr as $label) : ?>
                    <div class="px-1">
                        <div class="label simple"><span class="label-text"><?= $label ?></span></div>
                    </div>
                <?php endforeach ?>
            </div>
        </div>
        <div class="w-full md:w-1/2 mb-5">
            ...
            <div class="labels flex flex-wrap -mx-1">
                <?php foreach ($arr as $label) : ?>
                    <div class="px-1">
                        <div class="label simple clickable"><span class="label-text"><?= $label ?></span></div>
                    </div>
                <?php endforeach ?>
            </div>
        </div>
