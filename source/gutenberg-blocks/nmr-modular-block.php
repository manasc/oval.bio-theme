<section>
    <div class="grid grid-cols-3 h-screen">
        ...
        <div class=" w-full md:w-1/2 px-8 relative col-span-2 mb-20">
            <div class="w-full">
            ...
            <div class="absolute z-0 w-px h-64 " style="top: 50%; left:100%; background-color:black; transform: translate(10000%,-80%) rotate(48deg) ; ">
            </div>
