 ...
 * @since 1.13.0
 */
class WC_Product_Reviews_Pro_Loader {
	...
	/** @var \WC_Product_Reviews_Pro_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		require_once( plugin_dir_path( __FILE__ ) . 'class-wc-product-reviews-pro.php' );
	...
	/**
	 * Displays any admin notices added with \WC_Product_Reviews_Pro_Loader::add_admin_notice()
	 *
	 * @since 1.13.0
	 */
	 ...
	 * @since 1.13.0
	 *
	 * @return \WC_Product_Reviews_Pro_Loader
	 */
...
// fire it up!
WC_Product_Reviews_Pro_Loader::instance();
