...
$leftOver = 30 - count($peopleArr);
?>
<div class="pt-20 pb-32 bg-gray-400">
    <div class="container px-2 py-16 mx-auto">
        <div class="max-w-lg">
            <div class="text-5xl mb-4">Meet the Team.</div>
            <div class="text-lg mb-3">Breaking preconceived notions of what capitalism and free market economics are in the pursuit of providing extensive transparent access to functional life extension technology</div>
            <div class="label-text text-sm text-ovalGreenDark">Our Mission</div>
        </div>
    </div>
</div>
<div class="relative">
            ...
            <div class="flex flex-wrap -mx-2">
                <?php foreach ($peopleArr as $i => $p) : ?>
                    <div class="px-2 w-full md:w-1/3 lg:w-1/4 mb-5">
                        ...
                        <div class="label-text text-sm"><?php echo $p["name"] ?></div>
                    </div>
                <?php endforeach ?>
