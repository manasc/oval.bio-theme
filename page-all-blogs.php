...
<div class="hero-banner p-0 md:p-5">
    <div class="px-24 py-48 w-full rounded-none md:rounded-md overflow-hidden relative bg-cover bg-center bg-no-repeat flex flex-wrap items-center justify-start" style="background-image:url(<?php echo get_fake_images()[24]->urls->full ?>)">
...
<?php get_template_part('source/blocks/_product-grid') ?>
<?php get_footer() ?>