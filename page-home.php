...
<div class="hero-banner">
    <div class="container mx-auto">
        <div class="px-24 py-32 w-full rounded-none md:rounded-md overflow-hidden relative bg-cover bg-center bg-no-repeat flex flex-wrap items-center justify-start" style="background-image:url(<?php echo get_fake_images()[24]->urls->full ?>)">
