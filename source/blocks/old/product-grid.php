            ...
            <div class="product-box cursor-pointer w-full md:w-1/2 relative">
                ...
                <div class="absolute content p-5 h-full w-full">
                    <div class="title absolute">
                        <div class="text-4xl md:text-3xl lg:text-5xl font-light text-white leading-snug"><?= $box["name"] ?></div>
                        <div class="meta text-base text-xs lg:text-base"><?= $box["description"] ?></div>
                    </div>
